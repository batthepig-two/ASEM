...
function updateCalcRight(){
  ...
  if(!calcDino){ right.innerHTML='<div class="calc-hint">Wild Points v4 loaded. Select a dinosaur to start — this version has no Wild/Tamed toggle, Dom Lvl, or TE% fields.</div>'; return; }
  const d=calcDino;
  ...
  calc.appendChild(el('h3','','Wild Point Calculator v4 — No Taming Toggle'));
